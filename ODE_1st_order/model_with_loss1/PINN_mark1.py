...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  2 01:43:52 2025
...
x_physics = torch.linspace(0,4,50).view(-1,1).requires_grad_(True)# sample locations over the problem domain
lam=1
...
for i in range(100):
    ...
    yh = model(x_data)
    loss1 = (0.5)*torch.mean((yh-y_data)**2)# use mean squared error
    ...
    physics = (dx + lam*yhp)       
    loss2 = (0.5)*(torch.mean(physics**2))
