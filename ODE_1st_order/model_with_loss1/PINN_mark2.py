...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  2 02:21:38 2025
...
x_physics = torch.linspace(0,8,50).view(-1,1).requires_grad_(True)# sample locations over the problem domain
lam=1
...
for i in range(200):
    ...
    yh = model(x_data)
    loss1 = (0.9)*torch.mean((yh-y_data)**2)# use mean squared error
    ...
    physics_residual = d2y_dx2 + yhp
    loss2 = 0.1 * torch.mean(physics_residual**2)
